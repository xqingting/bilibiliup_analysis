...
def calcu(vmid_array):
    def calculate_tname_frequency(vmid):
        ...
        response = httpx.get("https://api.bilibili.com/x/space/coin/video", params=params)
...
def process_file(file_path):
    ...
    output_file = os.path.join(os.path.dirname(file_path), f"{os.path.splitext(file_name)[0]}_投币处理.txt")
